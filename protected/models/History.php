...
class History extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('number, cartId', 'numerical', 'integerOnly'=>true),
			array('productId, tableId, img, productName, price, note, waiter', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, productId, tableId, img, productName, price, number, note, cartId, waiter', 'safe', 'on'=>'search'),
		);
	}
