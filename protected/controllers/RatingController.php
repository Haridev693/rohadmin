...
class RatingController extends Controller
{
	...
	public function actionView($id,$date)
	{
		$this->render('view',array(
			'model'=>$this->loadModelCustomer($id,$date),
		));
	}
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Rating'])){
			...
			$model->dbCriteria->order='date DESC';
		}

		$model->dbCriteria->group='date,customerId';
	...
	public function loadModelCustomer($id,$date)
	{
		$model=Rating::model()->findAll('CustomerId = '.$id.' and date ="'.$date.'"');
		if($model===null)
			throw new CHttpException(404,'The requested page does not exist.');
		return $model;
	}
